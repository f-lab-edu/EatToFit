...
<ul>
  ...
  <li><a href="https://devwriter.tistory.com/59">[EatToFit] 매개변수가 매우 많을 때에는 도메인 생성 로직을 어떻게 작성해야 할까? (feat. 빌더 패턴, DDD)</li>
    <ul>
      <li>Food 도메인 생성 시 많은 매개변수로 인한 문제 상황 개선</li>
      <li>매개변수가 많은 도메인을 생성할 시에 대한 본인만의 기준 확립</li>
    </ul>
</ul>
